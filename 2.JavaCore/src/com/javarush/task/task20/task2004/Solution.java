...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File yourFile = new File("C:\\Games\\123.tmp");
            ...
            //here check that the classWithStatic object is equal
            // to the loadedObject object - проверьте тут, что classWithStatic и loadedObject равны
